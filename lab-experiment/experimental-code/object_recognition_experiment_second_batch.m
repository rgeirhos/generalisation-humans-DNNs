...
% with his permission to modify and use it if his and Britta Lewke's
% contribution is acknowledged. It has been modified extensively by
% Robert Geirhos to fit the experiment described above.
...
filepathToHere=pwd;
yamlFileName =  strcat('params_object_recognition_', exp_name, '_experiment.yaml'); 
